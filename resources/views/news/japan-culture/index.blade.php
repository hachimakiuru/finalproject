...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $newsTimeLine->created_at }}</td>
                <td>{{ $newsTimeLine->day }} - {{ $newsTimeLine->title }}</td>
                <td><img src="{{ asset('storage/img/' . $newsTimeLine->image) }}" alt="" width="100" height="100"></td>
                <td>
                    <a href="{{ route('news.show', $newsTimeLine->id) }}">show</a>
                </td>
            </tr>
            @endforeach
        </tbody>
