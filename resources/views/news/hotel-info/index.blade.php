                ...
                <div class="restaurant-dashboard-center">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <a href="{{ route('news.japan-culture') }}"><i class="ri-arrow-left-fill"></i></a><h4>Hotel Information</h4><a href="{{ route('news.event') }}"><i class="ri-arrow-right-fill"></i></a>
                        ...
                        <div class="col-md-7">
                            <div class="detail p-4">
                                <div class="detail">
                                    ...
                                    <p><strong>Price:</strong> {{ $newsTimeLine->price }}~yen ＊rough price</p>
