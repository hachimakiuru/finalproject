                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('restaurants.update', ['restaurant' => $restaurant]) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="address" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ $restaurant->address }}">
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" id="image" name="image_path" class="form-control @error('image_path') is-invalid @enderror" value="{{ $restaurant->image_path }}" aria-describedby="inputGroupFileAddon">
                                            @error('image_path')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>                        
                                    ...
                                    <div class="row">
                                        <div class="col-sm">
                                            <div class="mb-3 d-flex flex-column">
                                                ...
                                                <div>
                                                    <select class="form-select @error('genre_place') is-invalid @enderror" id="genre_place" name="genre_place" value="{{ $restaurant->genre_place}}">
                                        ...
                                        <div class="col-sm">
                                            <div class="mb-3 d-flex flex-column">
                                                ...
                                                <div>
                                                    <select class="form-select @error('genre_variety') is-invalid @enderror" id="genre_variety" name="genre_variety" value="{{ $restaurant->genre_variety}}">
                                                        <option selected disabled>選択してください</option>
                                        ...
                                        <div class="col-sm">
                                            <div class="mb-3 d-flex flex-column">
                                                ...
                                                <div>
                                                    <select class="form-select @error('genre_religion') is-invalid @enderror" id="genre_religion" name="genre_religion" value="{{ $restaurant->genre_religion}}">
                                                        <option selected disabled>選択してください</option>
                                        ...
                                        <div class="col-sm">
                                            <div class="mb-3 d-flex flex-column">
                                                ...
                                                <div>
                                                    <select class="form-select @error('genre_payment') is-invalid @enderror" id="genre_payment" name="genre_payment" value="{{ $restaurant->genre_payment}}">
                                                        <option selected disabled>選択してください</option>
